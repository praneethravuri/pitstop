"""Tests for tools/general/session.py — written TDD-first."""
...
from pitstop.tools.general.session import SessionDataResponse, get_session_data
...
@patch("pitstop.tools.general.session.fastf1_client")
